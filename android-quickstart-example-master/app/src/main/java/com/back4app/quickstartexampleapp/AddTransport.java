...
public class AddTransport extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    public void addTransport (View view){
        EditText nameTrans = (EditText) findViewById(R.id.nameTrans);
        EditText depStation = (EditText) findViewById(R.id.depStation);
        EditText arrStation = (EditText) findViewById(R.id.arrStation);
        EditText reservNr = (EditText) findViewById(R.id.reservNr);
        EditText price = (EditText) findViewById(R.id.priceTrans);
        EditText noteTrans = (EditText) findViewById(R.id.noteTrans);


        ParseObject Trans = new ParseObject("Transport");

        Trans.put("TripBy", ParseObject.createWithoutData("Trip",tripId));
        Trans.put("nameTrans", nameTrans.getText().toString());
        Trans.put("depStation", depStation.getText().toString());
        Trans.put("arrStation", arrStation.getText().toString());
        Trans.put("reservationNo", reservNr.getText().toString());
        Trans.put("price", Double.parseDouble(price.getText().toString()));
        Trans.put("departureDate", checkinDate);
        Trans.put("arrivalDate", checkoutDate);
        Trans.put("noteTrans", noteTrans.getText().toString());
...
//                    intent.putExtra("tripId", tripId);
    ...
    public void showTimePickerDialog(View v) {
        ...
        DialogFragment newFragment = new AddTransport.TimePickerFragment();
        newFragment.show(getSupportFragmentManager(), "timePicker");

    }
    public void showDatePickerDialog(View v) {
        datePickerInput = v.getId();
        DialogFragment newFragment = new AddTransport.DatePickerFragment();
